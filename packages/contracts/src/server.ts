...
import { ProviderAuthCapability } from "./providerAuth.ts";
...
export const ServerProviderAuth = Schema.Struct({
  ...
  methods: Schema.optionalKey(Schema.Array(ProviderAuthCapability)),
});
...
export const ServerProvider = Schema.Struct({
  ...
  activeTurnSteering: Schema.optional(Schema.Boolean),
  enabled: Schema.Boolean,
