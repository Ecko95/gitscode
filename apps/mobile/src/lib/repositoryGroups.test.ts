...
describe("groupProjectsByRepository", () => {
  it("groups projects across environments by repository identity", () => {
    const repoIdentity = {
      canonicalKey: "github.com/joshuaduffill/t3code",
      locator: {
        source: "git-remote" as const,
        remoteName: "origin",
        remoteUrl: "git@github.com:joshuaduffill/t3code.git",
      },
      provider: "github",
      owner: "joshuaduffill",
      name: "t3code",
    ...
    expect(groups[0]).toMatchObject({
      key: "github.com/joshuaduffill/t3code",
      title: "GITS",
      subtitle: "joshuaduffill/t3code",
      projectCount: 2,
      threadCount: 2,
    });
    expect(
