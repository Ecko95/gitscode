    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.workProviderInstanceId},
          ${row.workPersonalFallbackInstanceId},
          ${row.runtimeMode},
          ${row.activeTurnId},
          ${row.lastError},
          ${row.updatedAt}
        ...
        DO UPDATE SET
          ...
          work_provider_instance_id = excluded.work_provider_instance_id,
          work_personal_fallback_instance_id = excluded.work_personal_fallback_instance_id,
