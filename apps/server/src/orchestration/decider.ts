    ...
    case "project.create": {
      ...
      return {
        ...
        payload: {
          ...
          repositoryProfileOverride: command.repositoryProfileOverride ?? null,
    ...
    case "project.meta.update": {
      ...
      return {
        ...
        payload: {
          ...
          ...(command.repositoryProfileOverride !== undefined
            ? { repositoryProfileOverride: command.repositoryProfileOverride }
            : {}),
